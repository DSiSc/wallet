...
help:
	@echo 'Management commands for DSiSc/wallet:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building wallet ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/wallet/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/wallet/version.BuildDate=${BUILD_DATE}" ./...
