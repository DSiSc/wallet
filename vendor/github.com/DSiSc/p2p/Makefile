...
help:
	@echo 'Management commands for DSiSc/p2p:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building p2p ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/p2p/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/p2p/version.BuildDate=${BUILD_DATE}" ./...
