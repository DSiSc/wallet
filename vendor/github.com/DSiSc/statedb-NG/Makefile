...
help:
	@echo 'Management commands for DSiSc/statedb-NG:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building statedb-NG ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/statedb-NG/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/statedb-NG/version.BuildDate=${BUILD_DATE}" ./...
