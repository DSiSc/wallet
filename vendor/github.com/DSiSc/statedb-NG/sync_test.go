...
// account array.
func checkStateAccounts(t *testing.T, db ethdb.Database, root types.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ethdb.Database, root types.Hash) error {
