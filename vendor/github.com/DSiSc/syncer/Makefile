...
help:
	@echo 'Management commands for DSiSc/syncer:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building syncer ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/syncer/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/syncer/version.BuildDate=${BUILD_DATE}" ./...
